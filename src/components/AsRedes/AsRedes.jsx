...
const AsRedes = () => {
  return (
    <div>
      <ul className="AsRedes">
        <li className="icon-content">
          <a data-social="whatsapp" aria-label="Whatsapp" target='_blank' href={`https://api.whatsapp.com/send?phone=+573134530510&text=${encodeURIComponent("¡Hola! 👋 Soy cliente interesado en sus aves de Agroshop. ¿Podrían darme más información?")}`}
>
        ...
        <li className="icon-content">
          <a data-social="facebook" aria-label="Facebook" target='_blank' href="https://www.facebook.com/groups/4573743779356613">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" target='_blank' href="https://www.instagram.com/agroshopfarm/?hl=es">
            <div className="filled" />
